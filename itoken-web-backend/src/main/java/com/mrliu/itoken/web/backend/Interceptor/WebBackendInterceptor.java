package com.mrliu.itoken.web.backend.Interceptor;
...
import com.mrliu.itoken.web.backend.service.RedisService;
...
public class WebBackendInterceptor implements HandlerInterceptor {
    ...
    private static String LOCAL_SSO = "http://localhost:8603";
