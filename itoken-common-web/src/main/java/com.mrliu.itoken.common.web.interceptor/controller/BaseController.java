package com.mrliu.itoken.common.web.interceptor.controller;

import com.mrliu.itoken.common.domain.BaseDomain;
import com.mrliu.itoken.common.utils.MapperUtils;
import com.mrliu.itoken.common.web.interceptor.components.datatables.DataTablesResult;
...
public abstract class BaseController<T extends BaseDomain, S extends BaseClientService> {
    ...
    public DataTablesResult page(HttpServletRequest request) {
        ...
        int start = (strStart == null ? 0 : Integer.parseInt(strStart))/10;
