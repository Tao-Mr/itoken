package com.mrliu.itoken.common.dto;
...
public class BaseResult implements Serializable {
    ...
    public static BaseResult ok(String data) {
    ...
    public static BaseResult notok(Object data, List<Error> errors) {
        return createResult(RESULT_NOT_OK, data, SUCCESS, null, errors);
    }
